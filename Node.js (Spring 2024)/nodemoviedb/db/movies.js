...
const query = {
    // Select all movies from the database, parameterized by id
...
const deleteMovie = (req, res) => {
  ...
  // Delete all movies, for testing purposes
...
const updateMovie = (req, res) => {
    ...
    const query = {
      ...
      values: [movie.title, movie.director, movie.year, req.params.id],
    }
